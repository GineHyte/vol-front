...
export function getPlayers(paginationProps: PaginationProps = new PaginationProps()): Promise<Pagination<Player>> {
  return Api.get('/players/', paginationProps)
    .then((data: any) => {
...
export async function createPlayer(player: Player): Promise<Status> {
  return Api.post('/players/', player.serialize())
    .then((data: any) => {
...
export async function getTeams(paginationProps: PaginationProps = new PaginationProps()): Promise<Pagination<Team>> {
  return Api.get('/teams/', paginationProps)
    .then((data: any) => {
...
export async function createTeam(team: Team): Promise<Status> {
  return Api.post('/teams/', team.serialize())
    .then((data: any) => {
      return new Status().deserialize(data) as Status
    })
}
...
export async function getGames(
  ...
  return Api.get(`/games/?${query}`, paginationProps)
    .then((data: any) => {
...
export async function createGame(game: Game): Promise<Status> {
  return Api.post('/games/', game.serialize())
    .then((data: any) => {
      return new Status().deserialize(data) as Status
    })
}
...
export async function getActions(gameId: number, paginationProps: PaginationProps = new PaginationProps()): Promise<Pagination<Action>> {
  return Api.get(`/actions/?game_id=${gameId}`, paginationProps)
    .then((data: any) => {
      return new Pagination<Action>(data, Action)
    })
}

export async function getTechs(paginationProps: PaginationProps = new PaginationProps()): Promise<Pagination<Tech>> {
  return Api.get('/techs/', paginationProps)
    .then((data: any) => {
...
export async function createTech(tech: Tech): Promise<Status> {
  return Api.post('/techs/', tech.serialize())
    .then((data: any) => {
      return new Status().deserialize(data) as Status
    })
}
...
export async function deleteTech(id: number): Promise<Status> {
  return Api.delete(`/techs/${id}`)
    .then((data: any) => {
      return new Status().deserialize(data) as Status
    })
}

export async function getSubtechs(techId: number | undefined = undefined, paginationProps: PaginationProps = new PaginationProps()): Promise<Pagination<Subtech>> {
  let url = '/subtechs/';
  if (techId) {
    url += `?tech_id=${techId}`;
  }
  return Api.get(url, paginationProps)
    .then((data: any) => {
...
export async function createAction(action: Action): Promise<Status> {
  return Api.post('/actions/', action.serialize())
    .then((data: any) => {
      return new Status().deserialize(data) as Status
    })
}
...
export async function createSubtech(subtech: Subtech): Promise<Status> {
  return Api.post('/subtechs/', subtech.serialize())
    .then((data: any) => {
      return new Status().deserialize(data) as Status
    })
}
...
export async function getExercises(paginationProps: PaginationProps = new PaginationProps()): Promise<Pagination<Exercise>> {
  return Api.get('/exercises/', paginationProps)
    .then((data: any) => {
...
export async function createExercise(exercise: Exercise): Promise<Status> {
  return Api.post('/exercises/', exercise.serialize())
    .then((data: any) => {
      return new Status().deserialize(data) as Status
    })
}
